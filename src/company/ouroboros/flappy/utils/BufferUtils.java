...
public class BufferUtils {
	...
	public static ByteBuffer createByteBuffer(int[] array) {
		ByteBuffer result = ByteBuffer.allocateDirect(array.length * 4).order(ByteOrder.nativeOrder());
		result.asIntBuffer().put(array).flip();
		return result;
	}
